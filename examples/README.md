...
- AuthScript address formats: `nc1p...` / `tnc1p...` (generic v1), `pq1z...` / `tpq1z...` (PQ v2) and `nq1r...` / `tnq1r...` (ECDSA v3)
...
3. **Addresses**: Replace placeholder addresses with your actual wallet addresses. AuthScript examples use `pq1z...` / `nq1r...` / `nc1p...` addresses (testnet: `tpq1z...` / `tnq1r...` / `tnc1p...`).
